...
namespace App2.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,DepartmentName,DepartmentDescription")] Department department)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DepartmentName,DepartmentDescription")] Department department)
        {
            if (id != department.Id)
            {
                return NotFound();
